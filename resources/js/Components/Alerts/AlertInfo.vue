...
<template>
    <div :id="id" class="flex items-center p-4 mb-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
        role="alert">
        ...
        <button type="button"
            ...
            :data-dismiss-target="`#${id}`" aria-label="Fechar">
