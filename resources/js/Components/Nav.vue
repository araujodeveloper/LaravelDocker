        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <Link href="/dashboard" class="flex ml-2 md:mr-24">
                        <!-- <img src="https://flowbite-admin-dashboard.vercel.app/images/logo.svg" class="h-8 mr-3"
                            alt="FlowBite Logo" /> -->
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Beizi</span>
                    </Link>
                ...
                <div class="flex items-center">
                    ...
                    <!-- TODO Campo de notificações a se ativado no futuro -->

                    <!-- <button type="button" data-dropdown-toggle="notification-dropdown"
                        class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 mr-4">
                    ...
                    <button id="theme-toggle" @click="" data-tooltip-target="tooltip-toggle" type="button"
                    ...
                    <Form :action="'/logout'" :method="'post'" :token="token">
                    <button type="submit" data-tooltip-target="tooltip-logout"
                        class="hidden p-2 text-gray-500 rounded-lg sm:flex hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 mr-4">
                        <span class="sr-only">View notifications</span>


                                <svg class="mx-auto mb-1 text-gray-500 w-6 h-6 dark:text-gray-400" fill="none"
                    ...
                    <div class="flex items-center ml-3">
                        ...
                        <!-- TODO colocar a foto do usuário logado -->
